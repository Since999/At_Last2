...
C2DMesh::C2DMesh(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList) 
{
	...
	vertices[0].m_xmf3Position = { -0.5, -0.5, 0.0 };
	vertices[0].m_xmf2TexCoord = { 0.0, 1.0 };
	
	vertices[1].m_xmf3Position = { -0.5, 0.5, 0.0 };
	vertices[1].m_xmf2TexCoord = { 0.0, 0.0 };

	vertices[2].m_xmf3Position = { 0.5, 0.5, 0.0 };
	vertices[2].m_xmf2TexCoord = { 1.0, 0.0 };

	vertices[3].m_xmf3Position = { 0.5, 0.5, 0.0 };
	vertices[3].m_xmf2TexCoord = { 1.0, 0.0 };

	vertices[4].m_xmf3Position = { 0.5, -0.5, 0.0 };
	vertices[4].m_xmf2TexCoord = { 1.0, 1.0 };

	vertices[5].m_xmf3Position = { -0.5, -0.5, 0.0 };
	vertices[5].m_xmf2TexCoord = { 0.0, 1.0 };
...
C2DMeshLeftAnchor* C2DMeshLeftAnchor::singleton = NULL;

C2DMeshLeftAnchor* C2DMeshLeftAnchor::GetInstance()
{
	if (singleton) return singleton;
	singleton = new C2DMeshLeftAnchor(DEVICEMANAGER.pd3dDevice, DEVICEMANAGER.pd3dCommandList);
	return singleton;
}


C2DMeshLeftAnchor::C2DMeshLeftAnchor(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
{
	CTexturedVertex vertices[6];
	XMFLOAT3 normal = { 0.0, 0.0, 1.0 };
	for (int i = 0; i < 6; ++i) {
	...
	vertices[0].m_xmf3Position = { 0.0, 0.0, 0.0 };
	vertices[0].m_xmf2TexCoord = { 0.0, 1.0 };

	vertices[1].m_xmf3Position = { 0.0, 1.0, 0.0 };
	vertices[1].m_xmf2TexCoord = { 0.0, 0.0 };
	...
	vertices[4].m_xmf3Position = { 1.0, 0.0, 0.0 };
	vertices[4].m_xmf2TexCoord = { 1.0, 1.0 };

	vertices[5].m_xmf3Position = { 0.0, 0.0, 0.0 };
	vertices[5].m_xmf2TexCoord = { 0.0, 1.0 };
